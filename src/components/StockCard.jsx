...
export default function StockCard({ stock }) {
  ...
  return (
    <Link 
      ...
      className="block bg-white rounded-lg shadow-md hover-lift transition-all duration-200 p-4 sm:p-6 border border-gray-100 hover:border-blue-200"
    >
      ...
      <div className="space-y-2 sm:space-y-3">
        <div className="flex justify-between items-center">
          ...
          <div className={`flex items-center text-sm font-medium transition-colors ${
            ...
            <svg className={`w-3 h-3 sm:w-4 sm:h-4 mr-1 transition-transform ${isPositive ? 'rotate-0' : 'rotate-180'}`} fill="currentColor" viewBox="0 0 20 20">
